...
public class Report extends Command{
    ...
    public void report(Catalog c) throws IOException, TemplateException, ExceptieComanda {
        ...
        configuration.
                setDirectoryForTemplateLoading(new File("C:\\Users\\cristescu\\Desktop\\Facultate\\PA\\cristian_cristescu_A6_laborator5\\src\\main\\resources\\Templates"));
        ...
        try{
            ...
            File f = new File("C:\\Users\\cristescu\\Desktop\\template.html");
            desk.open(f);
        }finally {
            if(write!=null){
                write.flush();;
